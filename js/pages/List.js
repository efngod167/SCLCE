        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <h3>Marginal Note</h3>
                    <p>
                        Every level included in this list must be entirely spam-based and originate from the game <a style="color: #03bafc" href="https://en.wikipedia.org/wiki/Geometry_Dash">Geometry Dash</a>. This list ranks the top 100 hardest spam challenges in the game and is strictly a classic edition of spam challenge list, meaning all entries must rely on traditional, manual spamming skill. The difficulty of each level must reflect raw speed, control, consistency, and endurance using authentic classic spam mechanics.
                    </p>
                    <p>
                        SCLCE (or Spam Challenge List: Classic Edition) is a fan-made project and is not affiliated with, endorsed by, or associated with RobTopGames AB® in any way. It is also an unofficial project of SCL (The Spam Challenge List) and is also not affiliated with, connected to, or endorsed by the list. This project operates independently, similar to other community-run lists such as TSL (The Shitty List) and TLL (The Layout List). This list was created out of appreciation for the spam challenge community and as a way to celebrate and preserve the classic style of spam gameplay. Inspired by existing lists such as SCL, this project aims to provide a dedicated space for traditional, manual spam challenges while maintaining fairness, authenticity, and respect for the broader community.
                    </p>
                </div>
            </div>
        </main>
