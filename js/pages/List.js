        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        SCLCE (or Spam Challenge List Classic Edition) is a fan-made project and is not affiliated with, endorsed by, or associated with RobTopGames AB® in any way. This project operates independently, similar to other community-run lists such as TSL (The Shitty List) and TLL (The Layout List). It is also an unofficial project related to SCL, and is not affiliated with, connected to, or endorsed by that list as well. Furthermore, this list was created out of appreciation for the spam challenge community and as a way to celebrate and preserve the classic style of spam gameplay. Inspired by existing lists such as SCL and its eariler version (<a style="color: #03bafc" href="https://spamlist.pages.dev">spamlist.pages.dev</a>), this project aims to provide a dedicated space for traditional, manual spam challenges while maintaining fairness, authenticity, and respect for the broader community.
                    </p>
                </div>
            </div>
        </main>
